Login.widgets = {
	layoutBox1: ["wm.Layout", {"horizontalAlign":"center","styles":{},"verticalAlign":"top"}, {}, {
		panel1: ["wm.Panel", {"enableTouchHeight":true,"height":"100%","horizontalAlign":"center","styles":{},"verticalAlign":"middle","width":"100%"}, {}, {
			textUser: ["wm.Text", {"caption":"User","dataValue":"root","desktopHeight":"30px","displayValue":"root","height":"35px","required":true,"styles":{},"width":"90%"}, {}],
			textPassword: ["wm.Text", {"caption":"Password","dataValue":"alta","desktopHeight":"30px","displayValue":"alta","height":"35px","password":true,"width":"90%"}, {}],
